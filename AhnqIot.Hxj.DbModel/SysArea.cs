...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类SysArea 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class SysArea : Entity 
	{
		public SysArea():base("SysArea") {}
		...
		/// 农气科编码
		/// </summary>
		public string AwCode
		{
			get{ return _AwCode; }
			set
			{
				this.OnPropertyValueChange(_.AwCode,_AwCode,value);
				this._AwCode=value;
			}
		}
		/// <summary>
		...
		public override void SetPropertyValues(IDataReader reader)
		{
			...
			this._AwCode = DataUtils.ConvertValue<string>(reader["AwCode"]);
		...
		public override void SetPropertyValues(DataRow row)
		{
			...
			this._AwCode = DataUtils.ConvertValue<string>(row["AwCode"]);
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","SysArea");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","SysArea","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","SysArea","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","SysArea","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","SysArea","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","SysArea","更新用户");
			/// <summary>
			/// 区域名称
			/// </summary>
			public readonly static Field Name = new Field("Name","SysArea","区域名称");
			/// <summary>
			/// 上级
			/// </summary>
			public readonly static Field ParentSerialnum = new Field("ParentSerialnum","SysArea","上级");
			/// <summary>
			/// 农气科编码
			/// </summary>
			public readonly static Field AwCode = new Field("AwCode","SysArea","农气科编码");
			/// <summary>
			/// 状态。状态（1：启用，0：禁用，2...）
			/// </summary>
			public readonly static Field Status = new Field("Status","SysArea","状态。状态（1：启用，0：禁用，2...）");
			/// <summary>
			/// 描述
			/// </summary>
			public readonly static Field Description = new Field("Description","SysArea","描述");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","SysArea","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","SysArea","备注");
		}
		#endregion
