...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类FacilityPics 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class FacilityPics : Entity 
	{
		public FacilityPics():base("FacilityPics") {}
		...
		/// 设施
		/// </summary>
		public string FacilityCameraPresetSerialnum
		{
			get{ return _FacilityCameraPresetSerialnum; }
			set
			{
				this.OnPropertyValueChange(_.FacilityCameraPresetSerialnum,_FacilityCameraPresetSerialnum,value);
				this._FacilityCameraPresetSerialnum=value;
			}
		}
		/// <summary>
		/// 图片
		...
		public override Field[] GetFields()
		{
			return new Field[] {
				...
				_.FacilityCameraPresetSerialnum,
				_.PicSerialnum,
				_.Sort,
				_.Remark,
				_.FacilitySerialnum};
		...
		public override object[] GetValues()
		{
			return new object[] {
				...
				this._FacilityCameraPresetSerialnum,
				this._PicSerialnum,
				this._Sort,
				this._Remark,
		...
		public override void SetPropertyValues(IDataReader reader)
		{
			...
			this._FacilityCameraPresetSerialnum = DataUtils.ConvertValue<string>(reader["FacilityCameraPresetSerialnum"]);
		...
		public override void SetPropertyValues(DataRow row)
		{
			...
			this._FacilityCameraPresetSerialnum = DataUtils.ConvertValue<string>(row["FacilityCameraPresetSerialnum"]);
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","FacilityPics");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","FacilityPics","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","FacilityPics","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","FacilityPics","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","FacilityPics","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","FacilityPics","更新用户");
			/// <summary>
			/// 设施
			/// </summary>
			public readonly static Field FacilityCameraPresetSerialnum = new Field("FacilityCameraPresetSerialnum","FacilityPics","设施");
			/// <summary>
			/// 图片
			/// </summary>
			public readonly static Field PicSerialnum = new Field("PicSerialnum","FacilityPics","图片");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","FacilityPics","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","FacilityPics","备注");
			/// <summary>
			/// 
			/// </summary>
			public readonly static Field FacilitySerialnum = new Field("FacilitySerialnum","FacilityPics","FacilitySerialnum");
		}
		#endregion
