...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类DeviceExceptionSet 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class DeviceExceptionSet : Entity 
	{
		public DeviceExceptionSet():base("DeviceExceptionSet") {}
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","DeviceExceptionSet");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","DeviceExceptionSet","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","DeviceExceptionSet","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","DeviceExceptionSet","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","DeviceExceptionSet","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","DeviceExceptionSet","更新用户");
			/// <summary>
			/// 设备类型
			/// </summary>
			public readonly static Field DeviceSerialnum = new Field("DeviceSerialnum","DeviceExceptionSet","设备类型");
			/// <summary>
			/// 上限
			/// </summary>
			public readonly static Field Max = new Field("Max","DeviceExceptionSet","上限");
			/// <summary>
			/// 下限
			/// </summary>
			public readonly static Field Min = new Field("Min","DeviceExceptionSet","下限");
			/// <summary>
			/// 状态
			/// </summary>
			public readonly static Field Status = new Field("Status","DeviceExceptionSet","状态");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","DeviceExceptionSet","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","DeviceExceptionSet","备注");
		}
		#endregion
