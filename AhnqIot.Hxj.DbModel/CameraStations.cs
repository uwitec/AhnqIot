...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类CameraStations 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class CameraStations : Entity 
	{
		public CameraStations():base("CameraStations") {}
		...
		public int HttpPort
		{
			...
			set
			{
				this.OnPropertyValueChange(_.HttpPort,_HttpPort,value);
		...
		public int DataPort
		{
			...
			set
			{
				this.OnPropertyValueChange(_.DataPort,_DataPort,value);
		...
		public int RtspPort
		{
			...
			set
			{
				this.OnPropertyValueChange(_.RtspPort,_RtspPort,value);
		...
		public string StreamMedia
		{
			...
			set
			{
				this.OnPropertyValueChange(_.StreamMedia,_StreamMedia,value);
				this._StreamMedia=value;
			}
		}
		/// <summary>
		/// 介绍
		...
		public override void SetPropertyValues(IDataReader reader)
		{
			...
			this._HttpPort = DataUtils.ConvertValue<int>(reader["HttpPort"]);
			this._DataPort = DataUtils.ConvertValue<int>(reader["DataPort"]);
			this._RtspPort = DataUtils.ConvertValue<int>(reader["RtspPort"]);
			this._Channel = DataUtils.ConvertValue<int>(reader["Channel"]);
			this._StreamMedia = DataUtils.ConvertValue<string>(reader["StreamMedia"]);
		...
		public override void SetPropertyValues(DataRow row)
		{
			...
			this._HttpPort = DataUtils.ConvertValue<int>(row["HttpPort"]);
			this._DataPort = DataUtils.ConvertValue<int>(row["DataPort"]);
			this._RtspPort = DataUtils.ConvertValue<int>(row["RtspPort"]);
			this._Channel = DataUtils.ConvertValue<int>(row["Channel"]);
			this._StreamMedia = DataUtils.ConvertValue<string>(row["StreamMedia"]);
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","CameraStations");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","CameraStations","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","CameraStations","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","CameraStations","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","CameraStations","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","CameraStations","更新用户");
			/// <summary>
			/// 实景监测点
			/// </summary>
			public readonly static Field Name = new Field("Name","CameraStations","实景监测点");
			/// <summary>
			/// 机构
			/// </summary>
			public readonly static Field SysDepartmentSerialnum = new Field("SysDepartmentSerialnum","CameraStations","机构");
			/// <summary>
			/// 安装位置
			/// </summary>
			public readonly static Field Location = new Field("Location","CameraStations","安装位置");
			/// <summary>
			/// 经度
			/// </summary>
			public readonly static Field Lotitude = new Field("Lotitude","CameraStations","经度");
			/// <summary>
			/// 纬度
			/// </summary>
			public readonly static Field Latitude = new Field("Latitude","CameraStations","纬度");
			/// <summary>
			/// 安装时间
			/// </summary>
			public readonly static Field SetupTime = new Field("SetupTime","CameraStations","安装时间");
			/// <summary>
			/// 登录用户名
			/// </summary>
			public readonly static Field UserID = new Field("UserID","CameraStations","登录用户名");
			/// <summary>
			/// 登录密码
			/// </summary>
			public readonly static Field UserPwd = new Field("UserPwd","CameraStations","登录密码");
			/// <summary>
			/// IP地址
			/// </summary>
			public readonly static Field IP = new Field("IP","CameraStations","IP地址");
			/// <summary>
			/// web端口号
			/// </summary>
			public readonly static Field HttpPort = new Field("HttpPort","CameraStations","web端口号");
			/// <summary>
			/// 数据端口号
			/// </summary>
			public readonly static Field DataPort = new Field("DataPort","CameraStations","数据端口号");
			/// <summary>
			/// RTSP 端口
			/// </summary>
			public readonly static Field RtspPort = new Field("RtspPort","CameraStations","RTSP 端口");
			/// <summary>
			/// 通道
			/// </summary>
			public readonly static Field Channel = new Field("Channel","CameraStations","通道");
			/// <summary>
			/// 流媒体地址
			/// </summary>
			public readonly static Field StreamMedia = new Field("StreamMedia","CameraStations","流媒体地址");
			/// <summary>
			/// 介绍
			/// </summary>
			public readonly static Field Introduce = new Field("Introduce","CameraStations","介绍");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","CameraStations","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","CameraStations","备注");
		}
		#endregion
