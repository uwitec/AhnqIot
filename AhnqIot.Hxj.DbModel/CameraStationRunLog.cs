...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类CameraStationRunLog 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class CameraStationRunLog : Entity 
	{
		public CameraStationRunLog():base("CameraStationRunLog") {}
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","CameraStationRunLog");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","CameraStationRunLog","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","CameraStationRunLog","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","CameraStationRunLog","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","CameraStationRunLog","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","CameraStationRunLog","更新用户");
			/// <summary>
			/// 实景监测点编码
			/// </summary>
			public readonly static Field CameraStationsSerialnum = new Field("CameraStationsSerialnum","CameraStationRunLog","实景监测点编码");
			/// <summary>
			/// 在线状态
			/// </summary>
			public readonly static Field Status = new Field("Status","CameraStationRunLog","在线状态");
			/// <summary>
			/// 描述
			/// </summary>
			public readonly static Field Description = new Field("Description","CameraStationRunLog","描述");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","CameraStationRunLog","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","CameraStationRunLog","备注");
		}
		#endregion
