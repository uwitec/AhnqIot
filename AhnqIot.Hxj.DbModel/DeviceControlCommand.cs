...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类DeviceControlCommand 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class DeviceControlCommand : Entity 
	{
		public DeviceControlCommand():base("DeviceControlCommand") {}
		...
		private int _ControlContinueTime;
		private int _Status;
		private int _Sort;
		...
		public string Command
		{
			...
			set
			{
				this.OnPropertyValueChange(_.Command,_Command,value);
				this._Command=value;
			}
		}
		/// <summary>
		/// 控制指令执行的时间长度，单位秒，0为不自动结束控制。
		/// </summary>
		public int ControlContinueTime
		{
			get{ return _ControlContinueTime; }
			set
			{
				this.OnPropertyValueChange(_.ControlContinueTime,_ControlContinueTime,value);
				this._ControlContinueTime=value;
			}
		}
		/// <summary>
		/// F0为未执行，1为正在执行，2执行成功，3为执行失败，8为指令过期。
		/// </summary>
		public int Status
		{
			get{ return _Status; }
		...
		public override void SetPropertyValues(IDataReader reader)
		{
			...
			this._Command = DataUtils.ConvertValue<string>(reader["Command"]);
			this._ControlContinueTime = DataUtils.ConvertValue<int>(reader["ControlContinueTime"]);
		...
		public override void SetPropertyValues(DataRow row)
		{
			...
			this._Command = DataUtils.ConvertValue<string>(row["Command"]);
			this._ControlContinueTime = DataUtils.ConvertValue<int>(row["ControlContinueTime"]);
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","DeviceControlCommand");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","DeviceControlCommand","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","DeviceControlCommand","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","DeviceControlCommand","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","DeviceControlCommand","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","DeviceControlCommand","更新用户");
			/// <summary>
			/// 设备编码
			/// </summary>
			public readonly static Field DeviceSerialnum = new Field("DeviceSerialnum","DeviceControlCommand","设备编码");
			/// <summary>
			/// 指令
			/// </summary>
			public readonly static Field Command = new Field("Command","DeviceControlCommand","指令");
			/// <summary>
			/// 控制指令执行的时间长度，单位秒，0为不自动结束控制。
			/// </summary>
			public readonly static Field ControlContinueTime = new Field("ControlContinueTime","DeviceControlCommand","控制指令执行的时间长度，单位秒，0为不自动结束控制。");
			/// <summary>
			/// F0为未执行，1为正在执行，2执行成功，3为执行失败，8为指令过期。
			/// </summary>
			public readonly static Field Status = new Field("Status","DeviceControlCommand","F0为未执行，1为正在执行，2执行成功，3为执行失败，8为指令过期。");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","DeviceControlCommand","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","DeviceControlCommand","备注");
		}
		#endregion
