...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类DeviceRunLogType 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class DeviceRunLogType : Entity 
	{
		public DeviceRunLogType():base("DeviceRunLogType") {}
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","DeviceRunLogType");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","DeviceRunLogType","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","DeviceRunLogType","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","DeviceRunLogType","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","DeviceRunLogType","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","DeviceRunLogType","更新用户");
			/// <summary>
			/// 名称
			/// </summary>
			public readonly static Field Name = new Field("Name","DeviceRunLogType","名称");
			/// <summary>
			/// 描述
			/// </summary>
			public readonly static Field Introduce = new Field("Introduce","DeviceRunLogType","描述");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","DeviceRunLogType","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","DeviceRunLogType","备注");
		}
		#endregion
