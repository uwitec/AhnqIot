...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类DeviceType 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class DeviceType : Entity 
	{
		public DeviceType():base("DeviceType") {}
		...
		public int ValueCount
		{
			...
			set
			{
				this.OnPropertyValueChange(_.ValueCount,_ValueCount,value);
		...
		public override void SetPropertyValues(IDataReader reader)
		{
			...
			this._ValueCount = DataUtils.ConvertValue<int>(reader["ValueCount"]);
		...
		public override void SetPropertyValues(DataRow row)
		{
			...
			this._ValueCount = DataUtils.ConvertValue<int>(row["ValueCount"]);
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","DeviceType");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","DeviceType","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","DeviceType","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","DeviceType","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","DeviceType","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","DeviceType","更新用户");
			/// <summary>
			/// 名称
			/// </summary>
			public readonly static Field Name = new Field("Name","DeviceType","名称");
			/// <summary>
			/// 上级
			/// </summary>
			public readonly static Field ParentSerialnum = new Field("ParentSerialnum","DeviceType","上级");
			/// <summary>
			/// 形象图片
			/// </summary>
			public readonly static Field PhotoUrl = new Field("PhotoUrl","DeviceType","形象图片");
			/// <summary>
			/// 状态数量。采集：1 二态控制：2  三态控制：3
			/// </summary>
			public readonly static Field ValueCount = new Field("ValueCount","DeviceType","状态数量。采集：1 二态控制：2  三态控制：3");
			/// <summary>
			/// 描述
			/// </summary>
			public readonly static Field Introduce = new Field("Introduce","DeviceType","描述");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","DeviceType","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","DeviceType","备注");
		}
		#endregion
