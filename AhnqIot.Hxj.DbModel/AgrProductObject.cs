...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类AgrProductObject 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class AgrProductObject : Entity 
	{
		public AgrProductObject():base("AgrProductObject") {}
		...
		/// 类型
		/// </summary>
		public string AgrProducationTypeSerialnum
		{
			get{ return _AgrProducationTypeSerialnum; }
			set
			{
				this.OnPropertyValueChange(_.AgrProducationTypeSerialnum,_AgrProducationTypeSerialnum,value);
				this._AgrProducationTypeSerialnum=value;
			}
		}
		/// <summary>
		/// 介绍
		...
		public string CropUrl
		{
			...
			set
			{
				this.OnPropertyValueChange(_.CropUrl,_CropUrl,value);
				this._CropUrl=value;
			}
		}
		/// <summary>
		...
		public override object[] GetValues()
		{
			return new object[] {
				...
				this._Name,
				this._AgrProducationTypeSerialnum,
				this._Introduce,
				this._CropUrl,
				this._Remark,
				this._Sort};
		...
		public override void SetPropertyValues(IDataReader reader)
		{
			...
			this._AgrProducationTypeSerialnum = DataUtils.ConvertValue<string>(reader["AgrProducationTypeSerialnum"]);
			this._Introduce = DataUtils.ConvertValue<string>(reader["Introduce"]);
			this._CropUrl = DataUtils.ConvertValue<string>(reader["CropUrl"]);
		...
		public override void SetPropertyValues(DataRow row)
		{
			...
			this._AgrProducationTypeSerialnum = DataUtils.ConvertValue<string>(row["AgrProducationTypeSerialnum"]);
			this._Introduce = DataUtils.ConvertValue<string>(row["Introduce"]);
			this._CropUrl = DataUtils.ConvertValue<string>(row["CropUrl"]);
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","AgrProductObject");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","AgrProductObject","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","AgrProductObject","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","AgrProductObject","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","AgrProductObject","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","AgrProductObject","更新用户");
			/// <summary>
			/// 名称
			/// </summary>
			public readonly static Field Name = new Field("Name","AgrProductObject","名称");
			/// <summary>
			/// 类型
			/// </summary>
			public readonly static Field AgrProducationTypeSerialnum = new Field("AgrProducationTypeSerialnum","AgrProductObject","类型");
			/// <summary>
			/// 介绍
			/// </summary>
			public readonly static Field Introduce = new Field("Introduce","AgrProductObject","介绍");
			/// <summary>
			/// 病虫草害库链接地址
			/// </summary>
			public readonly static Field CropUrl = new Field("CropUrl","AgrProductObject","病虫草害库链接地址");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","AgrProductObject","备注");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","AgrProductObject","排序");
		}
		#endregion
