...
namespace AhnqIot.Hxj.DbModel
{
	...
	/// <summary>
	/// 实体类CameraStationPresetPoint 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class CameraStationPresetPoint : Entity 
	{
		public CameraStationPresetPoint():base("CameraStationPresetPoint") {}
		...
		public class _
		{
			...
			/// * 
			/// </summary>
			public readonly static Field All = new Field("*","CameraStationPresetPoint");
			/// <summary>
			/// 编码
			/// </summary>
			public readonly static Field Serialnum = new Field("Serialnum","CameraStationPresetPoint","编码");
			/// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreateTime = new Field("CreateTime","CameraStationPresetPoint","创建时间");
			/// <summary>
			/// 创建用户
			/// </summary>
			public readonly static Field CreateSysUserSerialnum = new Field("CreateSysUserSerialnum","CameraStationPresetPoint","创建用户");
			/// <summary>
			/// 更新时间
			/// </summary>
			public readonly static Field UpdateTime = new Field("UpdateTime","CameraStationPresetPoint","更新时间");
			/// <summary>
			/// 更新用户
			/// </summary>
			public readonly static Field UpdateSysUserSerialnum = new Field("UpdateSysUserSerialnum","CameraStationPresetPoint","更新用户");
			/// <summary>
			/// 预置点名称
			/// </summary>
			public readonly static Field Name = new Field("Name","CameraStationPresetPoint","预置点名称");
			/// <summary>
			/// 预置点位置
			/// </summary>
			public readonly static Field PresetPoint = new Field("PresetPoint","CameraStationPresetPoint","预置点位置");
			/// <summary>
			/// 实景监测站
			/// </summary>
			public readonly static Field CameraStationsSerialnum = new Field("CameraStationsSerialnum","CameraStationPresetPoint","实景监测站");
			/// <summary>
			/// 排序
			/// </summary>
			public readonly static Field Sort = new Field("Sort","CameraStationPresetPoint","排序");
			/// <summary>
			/// 备注
			/// </summary>
			public readonly static Field Remark = new Field("Remark","CameraStationPresetPoint","备注");
		}
		#endregion
