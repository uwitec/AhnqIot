...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    [DataObject]
    [Description("设备数据记录")]
    [BindIndex("Index_DeviceDataCreateTime", false, "CreateTime")]
    [BindIndex("Index_DeviceDataSensorDeviceUnitID", false, "SensorDeviceUnitID")]
    [BindIndex("PK__DeviceDa__3214EC271460D96D", true, "ID")]
    [BindRelation("SensorDeviceUnitID", false, "SensorDeviceUnit", "ID")]
    [BindTable("DeviceData", Description = "设备数据记录", ConnName = "SmartIot-Scada-DeviceData",
        DbType = DatabaseType.SqlServer)]
    public abstract partial class DeviceData<TEntity> : IDeviceData
    {
        #region 获取/设置 字段值
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.ShowValue:
                        ...
                        break;
                    case __.IsException:
                        _IsException = Convert.ToBoolean(value);
                        break;
                    case __.Max:
        ...
        public virtual Boolean IsException
        {
            ...
            set
            {
                if (OnPropertyChanging(__.IsException, value))
                {
                    _IsException = value;
                    OnPropertyChanged(__.IsException);
                }
            }
        }
        ...
        [Description("是否上传")]
        [DataObjectField(false, false, false, 1)]
        [BindColumn(13, "Upload", "是否上传", "0", "bit", 0, 0, false)]
        ...
        /// <summary>取得设备数据记录字段信息的快捷方式</summary>
        public class _
        {
            ///<summary>ID</summary>
        ...
        /// <summary>取得设备数据记录字段名称的快捷方式</summary>
        class __
        {
            ///<summary>ID</summary>
    ...
    /// <summary>设备数据记录接口</summary>
    public partial interface IDeviceData
    {
        #region 获取/设置 字段值
