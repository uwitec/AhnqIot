...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    public class TimeSharingStatistics : TimeSharingStatistics<TimeSharingStatistics>
    {
    }

    /// <summary>分时统计数据</summary>
    public partial class TimeSharingStatistics<TEntity> : LogEntity<TEntity>
        where TEntity : TimeSharingStatistics<TEntity>, new()
    {
        #region 高级查询
        ...
        //    var entity = new TimeSharingStatistics();
        //    entity.Code1 = "abc";
        //    entity.Code2 = "abc";
        //    entity.Code3 = "abc";
        ...
        /// <summary>该分时统计数据所对应的传感器设备</summary>
        [XmlIgnore]
        ...
        /// <summary>该分时统计数据所对应的传感器设备设备名称</summary>
        [XmlIgnore]
        ...
        /// <summary>根据分时时段查找</summary>
        /// <param name="timesharing">分时时段</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<TEntity> FindAllByTimeSharing(Int32 timesharing)
        {
            if (Meta.Count >= 1000)
                return FindAll(__.TimeSharing, timesharing);
            else // 实体缓存
                return Meta.Cache.Entities.FindAll(__.TimeSharing, timesharing);
        }
