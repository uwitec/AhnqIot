...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    public class DeviceDataExceptionLog : DeviceDataExceptionLog<DeviceDataExceptionLog>
    {
    }

    /// <summary>设备数据异常记录</summary>
    public partial class DeviceDataExceptionLog<TEntity> : LogEntity<TEntity>
        where TEntity : DeviceDataExceptionLog<TEntity>, new()
    {
        #region 高级查询
        ...
        /// <summary>该设备数据异常记录所对应的传感器设备</summary>
        [XmlIgnore]
        ...
        /// <summary>该设备数据异常记录所对应的传感器设备设备名称</summary>
        [XmlIgnore]
