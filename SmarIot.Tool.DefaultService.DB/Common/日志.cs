...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    [BindTable("ActionLog", Description = "日志", ConnName = "SmartIot-Scada-Log", DbType = DatabaseType.SqlServer)]
    public abstract partial class Log<TEntity> : ILog
    {
            ...
            set
            {
                switch (name)
                {
                    case __.ID:
                        ...
                        break;
                    case __.Category:
                        _Category = Convert.ToString(value);
                        break;
                    case __.Action:
                        _Action = Convert.ToString(value);
                        break;
                    case __.UserID:
                    ...
                    case __.UserName:
                        ...
                        break;
                    case __.IP:
                        _IP = Convert.ToString(value);
                        break;
                    case __.OccurTime:
                        _OccurTime = Convert.ToDateTime(value);
                        break;
                    case __.Remark:
        ...
        [BindColumn(1, "ID", "编号", "0", "int", 10, 0, false)]
        ...
        public virtual String Category
        {
            ...
            set
            {
                if (OnPropertyChanging(__.Category, value))
                {
                    _Category = value;
                    OnPropertyChanged(__.Category);
                }
            }
        }
        ...
        public virtual String Action
        {
            ...
            set
            {
                if (OnPropertyChanging(__.Action, value))
                {
                    _Action = value;
                    OnPropertyChanged(__.Action);
                }
            }
        }
        ...
        public virtual String UserName
        {
            ...
            set
            {
                if (OnPropertyChanging(__.UserName, value))
                {
                    _UserName = value;
                    OnPropertyChanged(__.UserName);
                }
            }
        }
        ...
        public virtual String IP
        {
            ...
            set
            {
                if (OnPropertyChanging(__.IP, value))
                {
                    _IP = value;
                    OnPropertyChanged(__.IP);
                }
            }
        }
        ...
        public virtual DateTime OccurTime
        {
            ...
            set
            {
                if (OnPropertyChanging(__.OccurTime, value))
                {
                    _OccurTime = value;
                    OnPropertyChanged(__.OccurTime);
                }
            }
        }
