...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    public partial class Log<TEntity> : Entity<TEntity> where TEntity : Log<TEntity>, new()
    {
        ...
        public static EntityList<TEntity> Search(String key, Int32 adminid, String category, DateTime start,
            DateTime end, String orderClause, Int32 startRowIndex, Int32 maximumRows)
        {
            if (String.IsNullOrEmpty(orderClause)) orderClause = _.ID.Desc();
            return FindAll(SearchWhere(key, adminid, category, start, end), orderClause, null, startRowIndex,
                maximumRows);
        }
        ...
        /// <param name="maximumRows"></param>
        /// <returns></returns>
        public static Int32 SearchCount(String key, Int32 adminid, String category, DateTime start, DateTime end,
            String orderClause, Int32 startRowIndex, Int32 maximumRows)
        {
        ...
        private static EntityCache<TEntity> _categoryCache;

        /// <summary>类别名实体缓存，异步，缓存10分钟</summary>
        private static EntityCache<TEntity> CategoryCache
        {
            get
            {
                if (_categoryCache == null)
                {
                    ...
                    _categoryCache.FillListMethod =
                        delegate { return FindAll("1=1 Group By " + _.Category, null, _.Category, 0, 0); };
                }
        ...
        /// <param name="action"></param>
        /// <returns></returns>
        ILog ILog.Create(Type type, String action)
        {
        ...
        {
            return String.Format("{0} {1} {2} {3:yyyy-MM-dd HH:mm:ss} {4}", Category, Action, UserName, OccurTime,
                Remark);
        }
