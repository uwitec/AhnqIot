...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    public class ShowData : ShowData<ShowData>
    {
    }

    /// <summary>显示数据</summary>
    public partial class ShowData<TEntity> : LogEntity<TEntity> where TEntity : ShowData<TEntity>, new()
    {
        #region 高级查询
        ...
        //    var entity = new ShowData();
        //    entity.SensorDeviceUnitID = 0;
        //    entity.ShowDeviceID = 0;
        //    entity.Position = 0;
        //    entity.Remark = "abc";
        //    entity.Insert();
        ...
        /// <summary>该显示数据所对应的传感器设备</summary>
        [XmlIgnore]
        ...
        /// <summary>该显示数据所对应的传感器设备设备名称</summary>
        [XmlIgnore]
        ...
        [NonSerialized] private ShowDevice _ShowDevice;

        /// <summary>该显示数据所对应的展示设备</summary>
        [XmlIgnore]
        public ShowDevice ShowDevice
        {
            get
            {
                if (_ShowDevice == null && ShowDeviceID > 0 && !Dirtys.ContainsKey("ShowDevice"))
                {
                    _ShowDevice = ShowDevice.FindByID(ShowDeviceID);
                    Dirtys["ShowDevice"] = true;
                }
                return _ShowDevice;
            }
            set { _ShowDevice = value; }
        }

        /// <summary>该显示数据所对应的展示设备名称</summary>
        [XmlIgnore]
        public String ShowDeviceName
        {
            get { return ShowDevice != null ? ShowDevice.Name : String.Empty; }
        }
        ...
        /// <summary>根据展示设备查找</summary>
        /// <param name="showdeviceid">展示设备</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<TEntity> FindAllByShowDeviceID(Int32 showdeviceid)
        {
            if (Meta.Count >= 1000)
                return FindAll(__.ShowDeviceID, showdeviceid);
            else // 实体缓存
                return Meta.Cache.Entities.FindAll(__.ShowDeviceID, showdeviceid);
        }
