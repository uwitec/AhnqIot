...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    public class ParmeterConfig : ParmeterConfig<ParmeterConfig>
    {
    }

    /// <summary>参数配置表</summary>
    public partial class ParmeterConfig<TEntity> : LogEntity<TEntity> where TEntity : ParmeterConfig<TEntity>, new()
    {
        #region 高级查询
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<TEntity> FindAllByType(String type)
        {
            if (Meta.Count >= 1000)
