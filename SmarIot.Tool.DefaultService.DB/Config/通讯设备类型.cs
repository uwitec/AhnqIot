...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    [DataObject]
    [Description("通讯设备类型")]
    [BindIndex("PK__Communic__3214EC27C02111D7", true, "ID")]
    [BindRelation("ID", true, "CommunicateDevice", "CommunicateDeviceTypeID")]
    [BindTable("CommunicateDeviceType", Description = "通讯设备类型", ConnName = "SmartIot-Scada",
        DbType = DatabaseType.SqlServer)]
    public abstract partial class CommunicateDeviceType<TEntity> : ICommunicateDeviceType
    {
        #region 获取/设置 字段值
        ...
        [BindColumn(3, "Remark", "备注", null, "nvarchar(1000)", 0, 0, true)]
        ...
        /// <summary>取得通讯设备类型字段信息的快捷方式</summary>
        partial class _
        {
            ///<summary>ID</summary>
        ...
        /// <summary>取得通讯设备类型字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>ID</summary>
    ...
    /// <summary>通讯设备类型接口</summary>
    public partial interface ICommunicateDeviceType
    {
        #region 获取/设置 字段值
