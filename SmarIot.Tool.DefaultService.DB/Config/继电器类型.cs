...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    [DataObject]
    [Description("继电器类型")]
    [BindIndex("PK__Relay__E3E7488DCD40871C", true, "Id")]
    [BindRelation("Id", true, "ControlDeviceUnit", "RelayTypeId")]
    [BindTable("RelayType", Description = "继电器类型", ConnName = "SmartIot-Scada", DbType = DatabaseType.SqlServer)]
    public abstract partial class RelayType<TEntity> : IRelayType
    {
        #region 获取/设置 字段值
        ...
        /// <summary>取得继电器类型字段信息的快捷方式</summary>
        partial class _
        {
            ///<summary>编号</summary>
        ...
        /// <summary>取得继电器类型字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编号</summary>
    ...
    /// <summary>继电器类型接口</summary>
    public partial interface IRelayType
    {
        #region 获取/设置 字段值
