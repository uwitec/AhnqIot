...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    [DataObject]
    [Description("设施传感器设备")]
    [BindIndex("PK_FacilitySensorDeviceUnit", true, "ID")]
    [BindIndex("IX_FacilitySensorDeviceUnit_FacilityID", false, "FacilityID")]
    [BindIndex("IX_FacilitySensorDeviceUnit_SensorDeviceUnitID", false, "SensorDeviceUnitID")]
    [BindRelation("FacilityID", false, "Facility", "ID")]
    [BindRelation("SensorDeviceUnitID", false, "SensorDeviceUnit", "ID")]
    [BindTable("FacilitySensorDeviceUnit", Description = "设施传感器设备", ConnName = "SmartIot-Scada",
        DbType = DatabaseType.SqlServer)]
    public abstract partial class FacilitySensorDeviceUnit<TEntity> : IFacilitySensorDeviceUnit
    {
        #region 获取/设置 字段值
        ...
        [Description("传感器设备")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(7, "SensorDeviceUnitID", "传感器设备", null, "int", 10, 0, false)]
        ...
        /// <summary>取得设施传感器设备字段信息的快捷方式</summary>
        partial class _
        {
            ///<summary>ID</summary>
        ...
        /// <summary>取得设施传感器设备字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>ID</summary>
    ...
    /// <summary>设施传感器设备接口</summary>
    public partial interface IFacilitySensorDeviceUnit
    {
        #region 获取/设置 字段值
