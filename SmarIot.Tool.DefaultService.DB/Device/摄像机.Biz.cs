...
namespace SmartIot.Tool.DefaultService.DB
{
    ...
    public class Camera : Camera<Camera>
    {
    }

    /// <summary>摄像机</summary>
    public partial class Camera<TEntity> : LogEntity<TEntity> where TEntity : Camera<TEntity>, new()
    {
        #region 扩展查询
        ...
        //    entity.UserID = "abc";
        //    entity.UserPwd = "abc";
        //    entity.CameraHost = "abc";
        //    entity.CameraHttpPort = 0;
        //    entity.CameraDataPort = 0;
        //    entity.CameraRTSPPort = 0;
        //    entity.Channel = 0;
        ...
        /// <summary>该摄像机所拥有的设施摄像机集合</summary>
        [XmlIgnore]
        [Category("关联选项"), DisplayName("该摄像机所拥有的设施摄像机集合")]
        [Description("该摄像机所拥有的设施摄像机集合"), TypeConverter(typeof(ExpandableObjectConverter))]
        public EntityList<FacilityCamera> FacilityCameras
        {
            get
            {
                ...
                {
                    _FacilityCameras = FacilityCamera.FindAllByCameraID(ID);
