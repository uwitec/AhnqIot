...
namespace AhnqIot.Dal
{
    ...
    public partial class ArticleCategory : Entity<ArticleCategory>
    {
        ...
        {
            if (ArticleContents != null) ArticleContents.Delete();
        ...
        [NonSerialized]
        private EntityList<ArticleContent> _ArticleContents;
        /// <summary>该文章分类所拥有的文章内容集合</summary>
        [XmlIgnore]
        public EntityList<ArticleContent> ArticleContents
        {
            get
            {
                if (_ArticleContents == null && !String.IsNullOrEmpty(Serialnum) && !Dirtys.ContainsKey("ArticleContents"))
                {
                    _ArticleContents = ArticleContent.FindAllByArticleCategorySerialnum(Serialnum);
                    Dirtys["ArticleContents"] = true;
                }
                return _ArticleContents;
            }
            set { _ArticleContents = value; }
        }
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static ArticleCategory FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<ArticleCategory> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
