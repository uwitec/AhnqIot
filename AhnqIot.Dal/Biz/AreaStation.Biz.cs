...
namespace AhnqIot.Dal
{
    ...
    public partial class AreaStation : Entity<AreaStation>
    {
        #region 对象操作
        ...
        {
            if (AreaStationDataInfos != null) AreaStationDataInfos.Delete();
        ...
        /// <summary>该基地关联气象站所对应的机构管理</summary>
        [XmlIgnore]
        ...
        /// <summary>该基地关联气象站所对应的机构管理机构名称</summary>
        [XmlIgnore]
        public String SysDepartmentName { get { return SysDepartment != null ? SysDepartment.Name : String.Empty; } }

        [NonSerialized]
        private EntityList<AreaStationDataInfo> _AreaStationDataInfos;
        /// <summary>该基地关联气象站所拥有的区域气象站数据记录集合</summary>
        [XmlIgnore]
        public EntityList<AreaStationDataInfo> AreaStationDataInfos
        {
            get
            {
                if (_AreaStationDataInfos == null && !String.IsNullOrEmpty(Serialnum) && !Dirtys.ContainsKey("AreaStationDataInfos"))
                {
                    _AreaStationDataInfos = AreaStationDataInfo.FindAllByAreaStationSerialnum(Serialnum);
                    Dirtys["AreaStationDataInfos"] = true;
                }
                return _AreaStationDataInfos;
            }
            set { _AreaStationDataInfos = value; }
        }

        [NonSerialized]
        private EntityList<Farm> _Farms;
        /// <summary>该基地关联气象站所拥有的企业基地集合</summary>
        [XmlIgnore]
        public EntityList<Farm> Farms
        {
            get
            {
                ...
                {
                    _Farms = Farm.FindAllByAreaStationSerialnum(Serialnum);
                    Dirtys["Farms"] = true;
                }
                return _Farms;
            }
        ...
        public static EntityList<AreaStation> FindAllBySysDepartmentSerialnum(String sysdepartmentserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static AreaStation FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<AreaStation> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
