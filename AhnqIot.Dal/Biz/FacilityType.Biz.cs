...
namespace AhnqIot.Dal
{
    ...
    public partial class FacilityType : Entity<FacilityType>
    {
        #region 对象操作
        ...
        public static EntityList<FacilityType> FindAllByName(String name)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static FacilityType FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<FacilityType> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
