...
{
    /// <summary>气象预警</summary>
    public partial class WeatherWarn : Entity<WeatherWarn>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(WeatherWarn).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new WeatherWarn();
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(WeatherWarn).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该气象预警所对应的机构管理机构名称</summary>
        [XmlIgnore]
        ...
        public static WeatherWarn FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<WeatherWarn> FindAllBySysDepartmentSerialnum(String sysdepartmentserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<WeatherWarn> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
