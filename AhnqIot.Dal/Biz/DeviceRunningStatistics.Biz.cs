...
namespace AhnqIot.Dal
{
    ...
    public partial class DeviceRunningStatistics : Entity<DeviceRunningStatistics>
    {
        #region 对象操作
        ...
        public override void Valid(Boolean isNew)
        {
            ...
            // 货币保留6位小数
            if (Dirtys[__.DataExceptionPercent]) DataExceptionPercent = Math.Round(DataExceptionPercent, 6);
        }
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(DeviceRunningStatistics).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new DeviceRunningStatistics();
        ...
        //    entity.DataExceptionCount = 0;
        //    entity.DataExceptionPercent = 0;
        //    entity.Sort = 0;
        //    entity.Remark = "abc";
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(DeviceRunningStatistics).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该企业设备运行统计所对应的企业设备</summary>
        [XmlIgnore]
        ...
        /// <summary>该企业设备运行统计所对应的企业设备名称</summary>
        [XmlIgnore]
        ...
        /// <param name="deviceserialnum">基地</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<DeviceRunningStatistics> FindAllByDeviceSerialnum(String deviceserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static DeviceRunningStatistics FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
