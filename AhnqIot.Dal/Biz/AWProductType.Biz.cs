...
namespace AhnqIot.Dal
{
    ...
    public partial class AWProductType : Entity<AWProductType>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(AWProductType).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new AWProductType();
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(AWProductType).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该农气服务产品类型所拥有的农气服务产品集合</summary>
        [XmlIgnore]
        public EntityList<AWProduct> AWProducts
        {
            get
            {
                ...
                {
                    _AWProducts = AWProduct.FindAllByAWProductTypeSerialnum(Serialnum);
        ...
        public static EntityList<AWProductType> FindAllByCreateTime(DateTime createtime)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static AWProductType FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<AWProductType> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
