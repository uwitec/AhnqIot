...
namespace AhnqIot.Dal
{
    ...
    public partial class FacilityProduceInfo : Entity<FacilityProduceInfo>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(FacilityProduceInfo).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new FacilityProduceInfo();
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(FacilityProduceInfo).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该设施种植养殖信息所对应的品种</summary>
        [XmlIgnore]
        ...
        /// <summary>该设施种植养殖信息所对应的基地设施名称</summary>
        [XmlIgnore]
        ...
        /// <summary>根据品种查找</summary>
        /// <param name="agrproductobjectserialnum">品种</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<FacilityProduceInfo> FindAllByAgrProductObjectSerialnum(String agrproductobjectserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<FacilityProduceInfo> FindAllByFacilitySerialnum(String facilityserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static FacilityProduceInfo FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<FacilityProduceInfo> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
