...
{
    /// <summary>图库</summary>
    public partial class PictureRep : Entity<PictureRep>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(PictureRep).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new PictureRep();
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(PictureRep).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static EntityList<PictureRep> FindAllByCreateTime(DateTime createtime)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static PictureRep FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<PictureRep> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
