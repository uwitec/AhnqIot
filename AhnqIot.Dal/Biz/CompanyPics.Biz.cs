...
{
    /// <summary>企业图库</summary>
    public partial class CompanyPics : Entity<CompanyPics>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(CompanyPics).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new CompanyPics();
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(CompanyPics).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        public static EntityList<CompanyPics> FindAllByCompanySerialnum(String companyserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static CompanyPics FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<CompanyPics> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
