...
{
    /// <summary>设备参数异常区间</summary>
    public partial class DeviceExceptionSet : Entity<DeviceExceptionSet>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(DeviceExceptionSet).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new DeviceExceptionSet();
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(DeviceExceptionSet).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该设备参数异常区间所对应的企业设备</summary>
        [XmlIgnore]
        ...
        /// <summary>该设备参数异常区间所对应的企业设备名称</summary>
        [XmlIgnore]
        ...
        /// <param name="deviceserialnum">设备类型</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<DeviceExceptionSet> FindAllByDeviceSerialnum(String deviceserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static DeviceExceptionSet FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<DeviceExceptionSet> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
