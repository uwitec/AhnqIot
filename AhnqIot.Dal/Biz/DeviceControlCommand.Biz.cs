...
namespace AhnqIot.Dal
{
    ...
    public partial class DeviceControlCommand : Entity<DeviceControlCommand>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(DeviceControlCommand).Name, Meta.Table.DataTable.DisplayName);
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(DeviceControlCommand).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该企业设备控制指令所对应的企业设备</summary>
        [XmlIgnore]
        ...
        /// <summary>该企业设备控制指令所对应的企业设备名称</summary>
        [XmlIgnore]
        ...
        public static EntityList<DeviceControlCommand> FindAllByDeviceSerialnum(String deviceserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static DeviceControlCommand FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<DeviceControlCommand> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
