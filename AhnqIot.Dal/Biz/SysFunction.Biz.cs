...
namespace AhnqIot.Dal
{
    ...
    /// <remarks></remarks>
    public partial class SysFunction : Entity<SysFunction>
    {
        #region 对象操作
        ...
        {
            if (SysMenus != null) SysMenus.Delete();
        ...
        [NonSerialized]
        private EntityList<SysMenu> _SysMenus;
        /// <summary>该SysFunction所拥有的导航集合</summary>
        [XmlIgnore]
        public EntityList<SysMenu> SysMenus
        {
            get
            {
                if (_SysMenus == null && !String.IsNullOrEmpty(Serialnum) && !Dirtys.ContainsKey("SysMenus"))
                {
                    _SysMenus = SysMenu.FindAllBySysFunctionSerialnum(Serialnum);
                    Dirtys["SysMenus"] = true;
                }
                return _SysMenus;
            }
            set { _SysMenus = value; }
        ...
        public static SysFunction FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<SysFunction> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
