...
namespace AhnqIot.Dal
{
    ...
    public partial class SysRole : Entity<SysRole>
    {
        #region 对象操作
        ...
        /// <summary>该系统角色所拥有的角色菜单集合</summary>
        [XmlIgnore]
        public EntityList<SysRoleMenu> SysRoleMenus
        {
            get
            {
                ...
                {
                    _SysRoleMenus = SysRoleMenu.FindAllBySysRoleSerialnum(Serialnum);
        ...
        public EntityList<SysUser> SysUsers
        {
            get
            {
                ...
                {
                    _SysUsers = SysUser.FindAllBySysRoleSerialnum(Serialnum);
        ...
        public static SysRole FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<SysRole> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
