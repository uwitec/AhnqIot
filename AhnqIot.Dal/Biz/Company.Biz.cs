...
namespace AhnqIot.Dal
{
    ...
    public partial class Company : Entity<Company>
    {
        ...
        {
            if (CompanyPicss != null) CompanyPicss.Delete();
        ...
        /// <summary>该企业所对应的机构管理机构名称</summary>
        [XmlIgnore]
        public String SysDepartmentName { get { return SysDepartment != null ? SysDepartment.Name : String.Empty; } }

        [NonSerialized]
        private EntityList<CompanyPics> _CompanyPicss;
        /// <summary>该企业所拥有的企业图库集合</summary>
        [XmlIgnore]
        public EntityList<CompanyPics> CompanyPicss
        {
            get
            {
                if (_CompanyPicss == null && !String.IsNullOrEmpty(Serialnum) && !Dirtys.ContainsKey("CompanyPicss"))
                {
                    _CompanyPicss = CompanyPics.FindAllByCompanySerialnum(Serialnum);
                    Dirtys["CompanyPicss"] = true;
                }
                return _CompanyPicss;
            }
            set { _CompanyPicss = value; }
        }

        [NonSerialized]
        private EntityList<CompanyUser> _CompanyUsers;
        /// <summary>该企业所拥有的企业用户集合</summary>
        [XmlIgnore]
        public EntityList<CompanyUser> CompanyUsers
        {
            get
            {
                ...
                {
                    _CompanyUsers = CompanyUser.FindAllByCompanySerialnum(Serialnum);
        ...
        public EntityList<Farm> Farms
        {
            get
            {
                ...
                {
                    _Farms = Farm.FindAllByCompanySerialnum(Serialnum);
                    Dirtys["Farms"] = true;
                }
                return _Farms;
            }
        ...
        public static EntityList<Company> FindAllBySysDepartmentSerialnum(String sysdepartmentserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static Company FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
