...
namespace AhnqIot.Dal
{
    ...
    public partial class AgrProduceCondition : Entity<AgrProduceCondition>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(AgrProduceCondition).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new AgrProduceCondition();
        ...
        //    entity.Month = 0;
        //    entity.Ten = "abc";
        //    entity.DevelopmentalStage = "abc";
        //    entity.SuitableCondition = "abc";
        //    entity.Sort = 0;
        //    entity.Remark = "abc";
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(AgrProduceCondition).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该农业气象指标库所对应的品种</summary>
        [XmlIgnore]
        ...
        /// <summary>该农业气象指标库所对应的品种名称</summary>
        [XmlIgnore]
        ...
        /// <summary>该农业气象指标库所对应的区域</summary>
        [XmlIgnore]
        ...
        /// <summary>该农业气象指标库所对应的区域区域名称</summary>
        [XmlIgnore]
        ...
        public static EntityList<AgrProduceCondition> FindAllByAgrProductObjectSerialnum(String agrproductobjectserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static AgrProduceCondition FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<AgrProduceCondition> FindAllBySysAreaSerialnum(String sysareaserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<AgrProduceCondition> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
