...
{
    /// <summary>企业设备运行记录类型</summary>
    public partial class DeviceRunLogType : Entity<DeviceRunLogType>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化{0}[{1}]数据……", typeof(DeviceRunLogType).Name, Meta.Table.DataTable.DisplayName);

        //    var entity = new DeviceRunLogType();
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化{0}[{1}]数据！", typeof(DeviceRunLogType).Name, Meta.Table.DataTable.DisplayName);
        //}
        ...
        /// <summary>该企业设备运行记录类型所拥有的企业设备运行记录集合</summary>
        [XmlIgnore]
        public EntityList<DeviceRunLog> DeviceRunLogs
        {
            get
            {
                ...
                {
                    _DeviceRunLogs = DeviceRunLog.FindAllByDeviceRunLogTypeSerialnum(Serialnum);
        ...
        public static EntityList<DeviceRunLogType> FindAllByCreateTime(DateTime createtime)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static DeviceRunLogType FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<DeviceRunLogType> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
