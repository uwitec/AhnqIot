    ...
    public partial class SysUser : Entity<SysUser>
    {
        ...
        public EntityList<CompanyUser> CompanyUsers
        {
            get
            {
                ...
                {
                    _CompanyUsers = CompanyUser.FindAllBySysUserSerialnum(Serialnum);
        ...
        /// <summary>该用户所对应的系统角色角色名称</summary>
        [XmlIgnore]
        ...
        public static SysUser FindBySerialnum(String serialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <param name="sysdepartmentserialnum">所属机构</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<SysUser> FindAllBySysDepartmentSerialnum(String sysdepartmentserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <param name="sysroleserialnum">角色</param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, false)]
        public static EntityList<SysUser> FindAllBySysRoleSerialnum(String sysroleserialnum)
        {
            if (Meta.Count >= 1000)
        ...
        /// <returns>实体集</returns>
        public static EntityList<SysUser> Search(Int32 userid, DateTime start, DateTime end, String key, PageParameter param)
        {
