...
namespace AhnqIot.Dal
{
    ...
    [DataObject]
    [Description("区域")]
    [BindIndex("PK__SysArea__E3E7488DB042CBE8", true, "Serialnum")]
    [BindRelation("Serialnum", true, "AgrProduceAnniversaryService", "SysAreaSerialnum")]
    [BindRelation("Serialnum", true, "AgrProduceCondition", "SysAreaSerialnum")]
    [BindRelation("Serialnum", true, "SysDepartment", "SysAreaSerialnum")]
    [BindTable("SysArea", Description = "区域", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class SysArea : ISysArea
    {
        #region 属性
        ...
        [BindColumn(6, "Name", "区域名称", null, "nvarchar(50)", 0, 0, true, Master=true)]
        ...
        /// <summary>农气科编码</summary>
        [DisplayName("农气科编码")]
        [Description("农气科编码")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(8, "AwCode", "农气科编码", null, "nvarchar(50)", 0, 0, true)]
        public virtual String AwCode
        {
            get { return _AwCode; }
            set { if (OnPropertyChanging(__.AwCode, value)) { _AwCode = value; OnPropertyChanged(__.AwCode); } }
        }
        ...
        public override Object this[String name]
        {
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.AwCode : _AwCode = Convert.ToString(value); break;
        ...
        public partial class _
        {
            ...
            ///<summary>农气科编码</summary>
            public static readonly Field AwCode = FindByName(__.AwCode);
        ...
        partial class __
        {
            ...
            ///<summary>农气科编码</summary>
            public const String AwCode = "AwCode";
    ...
    /// <summary>区域接口</summary>
    public partial interface ISysArea
    {
        #region 属性
        /// <summary>编码</summary>
