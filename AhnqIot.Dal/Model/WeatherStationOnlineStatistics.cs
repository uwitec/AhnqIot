...
namespace AhnqIot.Dal
{
    ...
    [Serializable]
    [DataObject]
    [Description("农田小气候仪到报率统计")]
    [BindIndex("IX_WeatherStationOnlineStatistics_WeatherStationSerialnum", false, "WeatherDeviceSerialnum")]
    [BindIndex("PK__WeatherS__E3E7488D54BBD3FD", true, "Serialnum")]
    [BindRelation("WeatherDeviceSerialnum", false, "WeatherDevice", "Serialnum")]
    [BindTable("WeatherStationOnlineStatistics", Description = "农田小气候仪到报率统计", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class WeatherStationOnlineStatistics : IWeatherStationOnlineStatistics
    {
        #region 属性
        ...
        [BindColumn(6, "WeatherDeviceSerialnum", "农田小气候仪", null, "nvarchar(50)", 0, 0, true)]
        public virtual String WeatherDeviceSerialnum
        {
            get { return _WeatherDeviceSerialnum; }
            set { if (OnPropertyChanging(__.WeatherDeviceSerialnum, value)) { _WeatherDeviceSerialnum = value; OnPropertyChanged(__.WeatherDeviceSerialnum); } }
        }
        ...
        [Description("实收次数")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(10, "ReceiveCount", "实收次数", null, "int", 10, 0, false)]
        ...
        /// <summary>应收次数</summary>
        [DisplayName("应收次数")]
        [Description("应收次数")]
        [DataObjectField(false, false, false, 10)]
        [BindColumn(11, "AllCount", "应收次数", null, "int", 10, 0, false)]
        ...
        [BindColumn(12, "ReceivePercent", "到报率", null, "decimal", 18, 1, false)]
        ...
        [Description("安装时间")]
        [DataObjectField(false, false, false, 3)]
        [BindColumn(13, "SetupTime", "安装时间", null, "datetime", 3, 0, false)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.WeatherDeviceSerialnum : return _WeatherDeviceSerialnum;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.WeatherDeviceSerialnum : _WeatherDeviceSerialnum = Convert.ToString(value); break;
        ...
        /// <summary>取得农田小气候仪到报率统计字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            ///<summary>农田小气候仪</summary>
            public static readonly Field WeatherDeviceSerialnum = FindByName(__.WeatherDeviceSerialnum);
        ...
        /// <summary>取得农田小气候仪到报率统计字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
            ...
            ///<summary>农田小气候仪</summary>
            public const String WeatherDeviceSerialnum = "WeatherDeviceSerialnum";
    ...
    /// <summary>农田小气候仪到报率统计接口</summary>
    public partial interface IWeatherStationOnlineStatistics
    {
        #region 属性
        /// <summary>编码</summary>
        ...
        /// <summary>农田小气候仪</summary>
        String WeatherDeviceSerialnum { get; set; }
