...
namespace AhnqIot.Dal
{
    ...
    [DataObject]
    [Description("作物诊断信息")]
    [BindIndex("IX_AgrDiagnosticModelFeedback_AgrDiagnosticModelSerialnum", false, "AgrDiagnosticModelSerialnum")]
    [BindIndex("PK__AgrDiagn__E3E7488D4A319A15", true, "Serialnum")]
    [BindRelation("AgrDiagnosticModelSerialnum", false, "AgrDiagnosticModel", "Serialnum")]
    [BindTable("AgrDiagnosticInfo", Description = "作物诊断信息", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class AgrDiagnosticInfo : IAgrDiagnosticInfo
    {
        #region 属性
        ...
        [BindColumn(6, "AgrDiagnosticModelSerialnum", "诊断模型", null, "nvarchar(50)", 0, 0, true)]
        public virtual String AgrDiagnosticModelSerialnum
        {
            get { return _AgrDiagnosticModelSerialnum; }
            set { if (OnPropertyChanging(__.AgrDiagnosticModelSerialnum, value)) { _AgrDiagnosticModelSerialnum = value; OnPropertyChanged(__.AgrDiagnosticModelSerialnum); } }
        }
        ...
        [BindColumn(7, "Info", "", null, "ntext", 0, 0, true)]
        ...
        [BindColumn(8, "Remark", "", null, "nvarchar(500)", 0, 0, true)]
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.AgrDiagnosticModelSerialnum : return _AgrDiagnosticModelSerialnum;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.AgrDiagnosticModelSerialnum : _AgrDiagnosticModelSerialnum = Convert.ToString(value); break;
        ...
        /// <summary>取得作物诊断信息字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            ///<summary>诊断模型</summary>
            public static readonly Field AgrDiagnosticModelSerialnum = FindByName(__.AgrDiagnosticModelSerialnum);
        ...
        /// <summary>取得作物诊断信息字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
            ...
            ///<summary>诊断模型</summary>
            public const String AgrDiagnosticModelSerialnum = "AgrDiagnosticModelSerialnum";
    ...
    /// <summary>作物诊断信息接口</summary>
    public partial interface IAgrDiagnosticInfo
    {
        #region 属性
        /// <summary>编码</summary>
        ...
        /// <summary>诊断模型</summary>
        String AgrDiagnosticModelSerialnum { get; set; }
