...
namespace AhnqIot.Dal
{
    ...
    [BindIndex("PK__CompanyP__E3E7488D0334762D", true, "Serialnum")]
    [BindRelation("CompanySerialnum", false, "Company", "Serialnum")]
    [BindTable("CompanyPics", Description = "企业图库", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class CompanyPics : ICompanyPics
    {
        #region 属性
        ...
        [BindColumn(2, "Sort", "排序", null, "int", 10, 0, false)]
        ...
        [BindColumn(4, "CreateSysUserSerialnum", "创建用户", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(7, "CompanySerialnum", "企业", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("图片")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(8, "PicSerialnum", "图片", null, "nvarchar(50)", 0, 0, true)]
        ...
        /// <summary>取得企业图库字段信息的快捷方式</summary>
        ...
        /// <summary>取得企业图库字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
    ...
    /// <summary>企业图库接口</summary>
    public partial interface ICompanyPics
    {
        #region 属性
        /// <summary>编码</summary>
