...
namespace AhnqIot.Dal
{
    ...
    [Serializable]
    [DataObject]
    [Description("企业设备运行记录类型")]
    [BindIndex("Index_CreateTime", false, "CreateTime")]
    [BindIndex("PK__CompanyD__E3E7488D7AE7B058", true, "Serialnum")]
    [BindRelation("Serialnum", true, "DeviceRunLog", "DeviceRunLogTypeSerialnum")]
    [BindTable("DeviceRunLogType", Description = "企业设备运行记录类型", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class DeviceRunLogType : IDeviceRunLogType
    {
        #region 属性
        ...
        [BindColumn(7, "Introduce", "描述", null, "ntext", 0, 0, true)]
        ...
        /// <summary>取得企业设备运行记录类型字段信息的快捷方式</summary>
        ...
        /// <summary>取得企业设备运行记录类型字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
    ...
    /// <summary>企业设备运行记录类型接口</summary>
    public partial interface IDeviceRunLogType
    {
        #region 属性
        /// <summary>编码</summary>
