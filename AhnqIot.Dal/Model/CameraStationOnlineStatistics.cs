...
namespace AhnqIot.Dal
{
    ...
    [Serializable]
    [DataObject]
    [Description("实景监测站在线统计")]
    [BindIndex("IX_CameraStationOnlineStatistics_CameraStationsSerialnum", false, "CameraStationsSerialnum")]
    [BindIndex("PK__CameraSt__E3E7488D301CB946", true, "Serialnum")]
    [BindRelation("CameraStationsSerialnum", false, "CameraStations", "Serialnum")]
    [BindTable("CameraStationOnlineStatistics", Description = "实景监测站在线统计", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class CameraStationOnlineStatistics : ICameraStationOnlineStatistics
    {
        #region 属性
        ...
        private String _CameraStationsSerialnum;
        /// <summary>实景监测站</summary>
        [DisplayName("实景监测站")]
        [Description("实景监测站")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(6, "CameraStationsSerialnum", "实景监测站", null, "nvarchar(50)", 0, 0, true)]
        public virtual String CameraStationsSerialnum
        {
            get { return _CameraStationsSerialnum; }
            set { if (OnPropertyChanging(__.CameraStationsSerialnum, value)) { _CameraStationsSerialnum = value; OnPropertyChanged(__.CameraStationsSerialnum); } }
        }
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.CameraStationsSerialnum : return _CameraStationsSerialnum;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.CameraStationsSerialnum : _CameraStationsSerialnum = Convert.ToString(value); break;
        ...
        /// <summary>取得实景监测站在线统计字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            ///<summary>实景监测站</summary>
            public static readonly Field CameraStationsSerialnum = FindByName(__.CameraStationsSerialnum);
        ...
        /// <summary>取得实景监测站在线统计字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
            ...
            ///<summary>实景监测站</summary>
            public const String CameraStationsSerialnum = "CameraStationsSerialnum";
    ...
    /// <summary>实景监测站在线统计接口</summary>
    public partial interface ICameraStationOnlineStatistics
    {
        #region 属性
        /// <summary>编码</summary>
        ...
        /// <summary>实景监测站</summary>
        String CameraStationsSerialnum { get; set; }
