...
namespace AhnqIot.Dal
{
    ...
    [DataObject]
    [Description("设施类型")]
    [BindIndex("Index_Name", false, "Name")]
    [BindIndex("PK__Facility__E3E7488DE6059EED", true, "Serialnum")]
    [BindRelation("Serialnum", true, "Facility", "FacilityTypeSerialnum")]
    [BindTable("FacilityType", Description = "设施类型", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class FacilityType : IFacilityType
    {
        ...
        [BindColumn(8, "IsSystem", "", "0", "bit", 0, 0, false)]
        ...
        [Description("css")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(9, "Css", "css", null, "nvarchar(50)", 0, 0, true)]
        public virtual String Css
        {
            get { return _Css; }
            set { if (OnPropertyChanging(__.Css, value)) { _Css = value; OnPropertyChanged(__.Css); } }
        }
        ...
        [BindColumn(11, "Introduce", "描述", null, "ntext", 0, 0, true)]
        ...
        public override Object this[String name]
        {
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.Css : _Css = Convert.ToString(value); break;
        ...
        public partial class _
        {
            ...
            ///<summary>css</summary>
            public static readonly Field Css = FindByName(__.Css);
