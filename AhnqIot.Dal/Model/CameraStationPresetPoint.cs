...
namespace AhnqIot.Dal
{
    ...
    [Serializable]
    [DataObject]
    [Description("实景监测系统预置点")]
    [BindIndex("IX_CameraStationPresetPoint_CameraStationsSerialnum", false, "CameraStationsSerialnum")]
    [BindIndex("PK__CameraSt__E3E7488D339A8F0A", true, "Serialnum")]
    [BindRelation("CameraStationsSerialnum", false, "CameraStations", "Serialnum")]
    [BindTable("CameraStationPresetPoint", Description = "实景监测系统预置点", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class CameraStationPresetPoint : ICameraStationPresetPoint
    {
        #region 属性
        ...
        [BindColumn(7, "PresetPoint", "预置点位置", null, "int", 10, 0, false)]
        ...
        [Description("实景监测站")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(8, "CameraStationsSerialnum", "实景监测站", null, "nvarchar(50)", 0, 0, true)]
        ...
        /// <summary>取得实景监测系统预置点字段信息的快捷方式</summary>
        ...
        /// <summary>取得实景监测系统预置点字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
    ...
    /// <summary>实景监测系统预置点接口</summary>
    public partial interface ICameraStationPresetPoint
    {
        #region 属性
        /// <summary>编码</summary>
