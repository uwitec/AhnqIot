...
namespace AhnqIot.Dal
{
    ...
    [Serializable]
    [DataObject]
    [Description("设施摄像机运行记录")]
    [BindIndex("IX_FacilityCameraRunRecord_FacilityCameraSerialnum", false, "FacilityCameraSerialnum")]
    [BindIndex("PK__Facility__E3E7488DDDEAAE22", true, "Serialnum")]
    [BindRelation("FacilityCameraSerialnum", false, "FacilityCamera", "Serialnum")]
    [BindTable("FacilityCameraRunLog", Description = "设施摄像机运行记录", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class FacilityCameraRunLog : IFacilityCameraRunLog
    {
        #region 属性
        ...
        /// <summary>企业摄像机</summary>
        [DisplayName("企业摄像机")]
        [Description("企业摄像机")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(6, "FacilityCameraSerialnum", "企业摄像机", null, "nvarchar(50)", 0, 0, true)]
        ...
        /// <summary>取得设施摄像机运行记录字段信息的快捷方式</summary>
        ...
        /// <summary>取得设施摄像机运行记录字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
    ...
    /// <summary>设施摄像机运行记录接口</summary>
    public partial interface IFacilityCameraRunLog
    {
        #region 属性
        /// <summary>编码</summary>
