...
namespace AhnqIot.Dal
{
    ...
    [DataObject]
    [Description("系统角色")]
    [BindIndex("PK__SysRole__E3E7488D0738C674", true, "Serialnum")]
    [BindRelation("Serialnum", true, "SysRoleMenu", "SysRoleSerialnum")]
    [BindRelation("Serialnum", true, "SysUser", "SysRoleSerialnum")]
    [BindTable("SysRole", Description = "系统角色", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class SysRole : ISysRole
    {
        #region 属性
        ...
        [BindColumn(6, "Name", "角色名称", null, "nvarchar(50)", 0, 0, true, Master=true)]
        ...
        [BindColumn(7, "Url", "访问地址", null, "nvarchar(500)", 0, 0, true)]
        ...
        [BindColumn(8, "IsSystem", "是否系统角色。系统角色用于业务系统开发使用，禁止修改名称或删除", null, "bit", 0, 0, false)]
        ...
        [Description("描述")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(9, "Description", "描述", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(11, "Permission", "权限。对不同资源的权限，逗号分隔，每个资源的权限子项竖线分隔", null, "ntext", 0, 0, true)]
        ...
        /// <summary>取得系统角色字段信息的快捷方式</summary>
        ...
        /// <summary>取得系统角色字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
