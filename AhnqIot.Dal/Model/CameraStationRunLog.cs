...
namespace AhnqIot.Dal
{
    ...
    [Serializable]
    [DataObject]
    [Description("实景监测点运行记录")]
    [BindIndex("IX_CameraStationRunRecord_CameraStationsSerialnum", false, "CameraStationsSerialnum")]
    [BindIndex("PK__CameraSt__E3E7488D13BC0075", true, "Serialnum")]
    [BindRelation("CameraStationsSerialnum", false, "CameraStations", "Serialnum")]
    [BindTable("CameraStationRunLog", Description = "实景监测点运行记录", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class CameraStationRunLog : ICameraStationRunLog
    {
        #region 属性
        ...
        /// <summary>实景监测点编码</summary>
        [DisplayName("实景监测点编码")]
        [Description("实景监测点编码")]
        [DataObjectField(false, false, false, 50)]
        [BindColumn(6, "CameraStationsSerialnum", "实景监测点编码", null, "nvarchar(50)", 0, 0, true)]
        ...
        [BindColumn(7, "Status", "在线状态", null, "bit", 0, 0, false)]
        ...
        /// <summary>取得实景监测点运行记录字段信息的快捷方式</summary>
        ...
        /// <summary>取得实景监测点运行记录字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
    ...
    /// <summary>实景监测点运行记录接口</summary>
    public partial interface ICameraStationRunLog
    {
        #region 属性
        /// <summary>编码</summary>
