...
namespace AhnqIot.Dal
{
    ...
    [DataObject]
    [Description("气象预警")]
    [BindIndex("PK__WeatherW__E3E7488DBA79F424", true, "Serialnum")]
    [BindIndex("IX_WeatherWarn_SysDepartmentSerialnum", false, "SysDepartmentSerialnum")]
    [BindRelation("SysDepartmentSerialnum", false, "SysDepartment", "Serialnum")]
    [BindTable("WeatherWarn", Description = "气象预警", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class WeatherWarn : IWeatherWarn
    {
        #region 属性
        ...
        [BindColumn(7, "Title", "标题", null, "nvarchar(200)", 0, 0, true, Master=true)]
        ...
        [BindColumn(10, "Views", "访问量", null, "int", 10, 0, false)]
        ...
        [Description("来源名称")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(11, "SourceName", "来源名称", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("来源地址")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn(12, "SourceUrl", "来源地址", null, "nvarchar(50)", 0, 0, true)]
        ...
        [Description("发布时间")]
        [DataObjectField(false, false, false, 3)]
        [BindColumn(13, "PublishTime", "发布时间", null, "datetime", 3, 0, false)]
        ...
        /// <summary>取得气象预警字段信息的快捷方式</summary>
        ...
        /// <summary>取得气象预警字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
    ...
    /// <summary>气象预警接口</summary>
    public partial interface IWeatherWarn
    {
        #region 属性
        /// <summary>编码</summary>
