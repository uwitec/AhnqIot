...
namespace AhnqIot.Dal
{
    ...
    [DataObject]
    [Description("实景监测点图库")]
    [BindIndex("IX_CameraStationPics_CameraStationsSerialnum", false, "CameraStationsPresetSerialnum")]
    [BindIndex("IX_CameraStationPics_CreateTime", false, "CreateTime")]
    [BindIndex("IX_CameraStationPics_PicSerialnum", false, "PicSerialnum")]
    [BindIndex("PK__CameraSt__E3E7488DC5FCB583", true, "Serialnum")]
    [BindTable("CameraStationPics", Description = "实景监测点图库", ConnName = "ConnName", DbType = DatabaseType.SqlServer)]
    public partial class CameraStationPics : ICameraStationPics
    {
        #region 属性
        ...
        [BindColumn(6, "CameraStationsPresetSerialnum", "实景监测站", null, "nvarchar(50)", 0, 0, true)]
        public virtual String CameraStationsPresetSerialnum
        {
            get { return _CameraStationsPresetSerialnum; }
            set { if (OnPropertyChanging(__.CameraStationsPresetSerialnum, value)) { _CameraStationsPresetSerialnum = value; OnPropertyChanged(__.CameraStationsPresetSerialnum); } }
        }
        ...
        public override Object this[String name]
        {
            get
            {
                switch (name)
                {
                    ...
                    case __.CameraStationsPresetSerialnum : return _CameraStationsPresetSerialnum;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case __.CameraStationsPresetSerialnum : _CameraStationsPresetSerialnum = Convert.ToString(value); break;
        ...
        /// <summary>取得实景监测点图库字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            ///<summary>实景监测站</summary>
            public static readonly Field CameraStationsPresetSerialnum = FindByName(__.CameraStationsPresetSerialnum);
        ...
        /// <summary>取得实景监测点图库字段名称的快捷方式</summary>
        partial class __
        {
            ///<summary>编码</summary>
            ...
            ///<summary>实景监测站</summary>
            public const String CameraStationsPresetSerialnum = "CameraStationsPresetSerialnum";
    ...
    /// <summary>实景监测点图库接口</summary>
    public partial interface ICameraStationPics
    {
        #region 属性
        /// <summary>编码</summary>
        ...
        /// <summary>实景监测站</summary>
        String CameraStationsPresetSerialnum { get; set; }
